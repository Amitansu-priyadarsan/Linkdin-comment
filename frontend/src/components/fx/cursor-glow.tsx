...
/**
 * Soft violet glow that trails the cursor across the whole page.
...
export function CursorGlow() {
  ...
  return (
    <motion.div
      aria-hidden
      style={{ x, y }}
      className="pointer-events-none fixed left-0 top-0 z-[5] size-[500px] rounded-full bg-[radial-gradient(circle,rgba(124,58,237,0.10),rgba(6,182,212,0.05)_45%,transparent_70%)] mix-blend-screen"
    />
  );
}
